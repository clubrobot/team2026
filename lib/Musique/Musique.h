//
// Created by Пикселбо on 28/01/2025.
//
...
const inline int16_t neverGonneGiveYouUp[] = {
    680/2, 114, 4,
...
class Musique {
    public:
        ...
        Musique(uint32_t pin, uint8_t defaultVolume);
