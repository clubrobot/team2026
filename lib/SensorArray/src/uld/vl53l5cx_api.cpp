...
uint8_t VL53L5CX::_vl53l5cx_poll_for_answer(
		uint8_t					size,
		uint8_t					pos,
		uint16_t				address,
		uint8_t					mask,
 ...
 */
uint8_t VL53L5CX::_vl53l5cx_poll_for_mcu_boot()
{
...
uint8_t VL53L5CX::_vl53l5cx_send_offset_data(
		uint8_t						resolution)
{
	uint8_t status = VL53L5CX_STATUS_OK;
...
uint8_t VL53L5CX::_vl53l5cx_send_xtalk_data(
		uint8_t				resolution)
{
	uint8_t status = VL53L5CX_STATUS_OK;
...
uint8_t VL53L5CX::vl53l5cx_is_alive(
		uint8_t				*p_is_alive)
{
	uint8_t status = VL53L5CX_STATUS_OK;
...
uint8_t VL53L5CX::vl53l5cx_init()
{
	...
	status |= WrByte(&(p_dev->platform), 0x7fff, 0x00);
	status |= _vl53l5cx_poll_for_answer(1, 0, 0x06, 0xff, 1);
	if(status != (uint8_t)0){
		goto exit;
	}
	...
	status |= _vl53l5cx_poll_for_answer(1, 0, 0x21, 0x10, 0x10);
	status |= WrByte(&(p_dev->platform), 0x7fff, 0x00);
	...
	status |= _vl53l5cx_poll_for_mcu_boot();
	if(status != (uint8_t)0){
		goto exit;
	}
	...
	status |= _vl53l5cx_poll_for_answer(4, 0,
	...
	(void)memcpy(p_dev->offset_data, p_dev->temp_buffer,
		VL53L5CX_OFFSET_BUFFER_SIZE);
	status |= _vl53l5cx_send_offset_data(VL53L5CX_RESOLUTION_4X4);

	/* Set default Xtalk shape. Send Xtalk to sensor */
	(void)memcpy(p_dev->xtalk_data, (uint8_t*)VL53L5CX_DEFAULT_XTALK,
		VL53L5CX_XTALK_BUFFER_SIZE);
	status |= _vl53l5cx_send_xtalk_data(VL53L5CX_RESOLUTION_4X4);
	...
	status |= vl53l5cx_dci_write_data((uint8_t*)&pipe_ctrl,
	...
	status |= vl53l5cx_dci_write_data((uint8_t*)&single_range,
			VL53L5CX_DCI_SINGLE_RANGE,
			(uint16_t)sizeof(single_range));

	tmp = (uint8_t)1;
	status |= vl53l5cx_dci_replace_data(p_dev->temp_buffer,
...
uint8_t VL53L5CX::vl53l5cx_set_i2c_address(
...
uint8_t VL53L5CX::vl53l5cx_get_power_mode(
...
uint8_t VL53L5CX::vl53l5cx_set_power_mode(
		uint8_t			        power_mode)
{
...
uint8_t VL53L5CX::vl53l5cx_check_data_ready(
		uint8_t				*p_isReady)
{
	uint8_t status = VL53L5CX_STATUS_OK;
...
uint8_t VL53L5CX::vl53l5cx_get_ranging_data(
...
uint8_t VL53L5CX::vl53l5cx_get_resolution(
		uint8_t				*p_resolution)
{
	uint8_t status = VL53L5CX_STATUS_OK;

	status |= vl53l5cx_dci_read_data( p_dev->temp_buffer,
...
uint8_t VL53L5CX::vl53l5cx_set_resolution(
		uint8_t				resolution)
{
	uint8_t status = VL53L5CX_STATUS_OK;
...
uint8_t VL53L5CX::vl53l5cx_get_ranging_frequency_hz(
		uint8_t				*p_frequency_hz)
{
	uint8_t status = VL53L5CX_STATUS_OK;

	status |= vl53l5cx_dci_read_data((uint8_t*)p_dev->temp_buffer,
...
uint8_t VL53L5CX::vl53l5cx_set_ranging_frequency_hz(
...
uint8_t VL53L5CX::vl53l5cx_get_integration_time_ms(
		uint32_t			*p_time_ms)
{
	uint8_t status = VL53L5CX_STATUS_OK;
...
uint8_t VL53L5CX::vl53l5cx_set_integration_time_ms(
...
uint8_t VL53L5CX::vl53l5cx_get_sharpener_percent(
...
uint8_t VL53L5CX::vl53l5cx_set_sharpener_percent(
...
uint8_t VL53L5CX::vl53l5cx_set_target_order(
...
uint8_t VL53L5CX::vl53l5cx_get_ranging_mode(
...
uint8_t VL53L5CX::vl53l5cx_set_ranging_mode(
		uint8_t				ranging_mode)
{
	...
	status |= vl53l5cx_dci_write_data(p_dev->temp_buffer,
...
uint8_t VL53L5CX::vl53l5cx_enable_internal_cp()
{
	uint8_t status = VL53L5CX_STATUS_OK;
...
uint8_t VL53L5CX::vl53l5cx_disable_internal_cp()
{
	uint8_t status = VL53L5CX_STATUS_OK;
...
uint8_t VL53L5CX::vl53l5cx_get_VHV_repeat_count(
...
uint8_t VL53L5CX::vl53l5cx_set_VHV_repeat_count(
...
uint8_t VL53L5CX::vl53l5cx_dci_read_data(
		uint8_t				*data,
		uint32_t			index,
		uint16_t			data_size)
{
...
uint8_t VL53L5CX::vl53l5cx_dci_replace_data(
		uint8_t				*data,
		uint32_t			index,
		uint16_t			data_size,
		uint8_t				*new_data,
