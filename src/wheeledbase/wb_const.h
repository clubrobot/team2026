...
#define VELOCITYCONTROL_MAXLINACC_VALUE 500/3
#define VELOCITYCONTROL_MAXLINDEC_VALUE 1000/2
#define VELOCITYCONTROL_MAXANGACC_VALUE 3.14/3
#define VELOCITYCONTROL_MAXANGDEC_VALUE 6.28/2
